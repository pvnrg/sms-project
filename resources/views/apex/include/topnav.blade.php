				...
				<!--  <li class="dropdown nav-item">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                      <a href="{{request()->fullUrlWithQuery(['lang'=>'en'])}}" class="dropdown-item py-1">
                          <img src="{!! asset('apex/img/flags/us.png') !!}" class="langimg"><span> @lang('common.country.english')</span>
                      </a>
                      <a href="{{request()->fullUrlWithQuery(['lang'=>'he'])}}" class="dropdown-item">
                          <img src="{!! asset('apex/img/flags/he.png') !!}" class="langimg"><span> @lang('common.country.hebrew')</span>
                      </a>
                  </div>
                </li>  -->
