	        ...
	        <div class="card">
	            <div class="card-header">
                        <a href="{{ url('/admin/permissions') }}" title="Back">
                            <button class="btn-link-back"><i class="fa fa-arrow-left" aria-hidden="true"></i> @lang('common.label.back')
                            </button>
                        </a>
	                 <div class="next_previous pull-right">
                            ...
                            @if(Auth::user()->can('access.permission.delete'))
                                ...
                                {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i> '.trans('common.label.delete'), array(
                                        'type' => 'submit',
                                        'class' => 'btn-link-dlt',
                                        'title' => 'Delete Permission',
                                        'onclick'=>"return confirm('".trans('common.js_msg.confirm_for_delete',['item_name'=>'Permission'])."')"
                                ))!!}
                                {!! Form::close() !!}
                            @endif
                                   ...
                                   <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>@lang('common.label.name')</th>
                                                    <th>@lang('common.label.label')</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
