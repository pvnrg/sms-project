	        ...
	        <div class="card">
	            <div class="card-header">
                        <a href="{{ url('/admin/roles') }}" title="Back">
                            <button class="btn btn-warning btn-xs"><i class="fa fa-arrow-left" aria-hidden="true"></i> @lang('common.label.back')
                            </button>
                        </a>
                            ...
                            @if($role->id != 1)
                                ...
                                @if(Auth::user()->can('access.role.delete'))
                                    ...
                                    {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i> '.trans('common.label.delete'), array(
                                            ...
                                            'title' => 'Delete Role',
                                            'onclick'=>"return confirm('".trans('common.js_msg.confirm_for_delete',['item_name'=>'Role'])."')"
                                    ))!!}
                                    {!! Form::close() !!}
                                @endif
                            @endif
