	            ...
	            <div class="card-header">
                        <a href="{{ url('/admin/roles') }}" title="{{__('Back')}}">
                            <button class="btn-link-back"><i class="fa fa-arrow-left"
                                                                      aria-hidden="true"></i> @lang('common.label.back') </button>
                        </a>
	                
                        
                          <div class="next_previous pull-right">
                                <a href="javascript:document.getElementById('module_form').submit();" title="Update" class="navbar-right btn-link"> @lang('common.label.update')</a>
                          </div>  
	            ...
	            <div class="card-body">
	                <div class="px-3">
	                    ...
	                    {!! Form::model($role, [
                            ...
                            @include ('admin.roles.form', ['submitButtonText' => trans('common.label.update')])
