...
@section('title',trans('class.label.edit_transaction_type'))
...
@section('content')
    ...
    <div class="row">
            <div class="col-sm-12">
                <div class="content-header"> @lang('class.label.edit_transaction_type') # {{$transaction_types->name}} </div>
            </div>
        </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="px-3">
                            ...
                            @include ('admin.transaction_types.form', ['submitButtonText' => trans('common.label.update')])
