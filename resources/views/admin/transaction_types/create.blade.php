...
@section('title',trans('class.label.creater_transaction_type'))
...
@section('content')
	...
	<div class="row">
            <div class="col-sm-12">
                <div class="content-header"> @lang('class.label.create_new_transaction_type') </div>
            </div>
        </div>
	<div class="row">
	    <div class="col-md-12">
	        <div class="card">
	            ...
	            <div class="card-body">
	                <div class="px-3">
                            ...
                            @endif
	                     {!! Form::open(['url' => '/admin/transaction_types', 'class' => 'form-horizontal','files' => true,'autocomplete'=>'off']) !!}
