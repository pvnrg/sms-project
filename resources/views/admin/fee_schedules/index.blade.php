...
@section('title',trans('class.label.fee_schedules'))

@section('content')

<div class="row">
    <div class="col-sm-12">
        <div class="content-header"> @lang('class.label.fee_schedules') </div>
                ...
                <div class="card-header">
                    ...
                    <div class="col-3">
                        <div class="actions pull-left">
                                ...
                                <a href="{{ url('/admin/fee_schedules/create') }}" class="btn btn-success btn-sm"
                                   title="Add New User">
...
<script>
    ...
    var url = "{{url('admin/fee_schedules')}}";
    ...
    datatable = $('.datatable').dataTable({
        ...
        columns: [
            ...
            { "data": "fees","name":"fees","searchable": false,"width":"18%"},
        ...
        ajax: {
            url: "{{ url('admin/fee_schedules/datatable') }}", // json datasource
