    ...
    <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
            <label for="title" class="">
                ...
                {!! Form::text('name', isset($client_classes->name) ? $client_classes->name : '', ['class' => 'form-control']) !!}
        ...
        <div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
            <label for="description" class="">
                ...
                {!! Form::textarea('description', isset($client_classes->description) ? $client_classes->description : '', ['class' => 'form-control']) !!}
