...
@section('title',trans('class.label.show_client_class'))
...
@section('content')
    ...
    <div class="row">
            <div class="col-sm-12">
                <div class="content-header"> @lang('class.label.show_client_class')</div>
                                   ...
                                   <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $client_classes->id }}</td>
                                            </tr>
                                            <tr>

                                                <td>@lang('class.label.name')</td>
                                                <td> {{ $client_classes->name }} </td>
                                            </tr>
                                            <tr>
                                                <td>@lang('class.label.description')</td>
                                                <td> {{ $client_classes->description }} </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
