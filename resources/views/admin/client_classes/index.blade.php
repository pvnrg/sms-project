...
@section('title',trans('class.label.client_classe'))

@section('content')

<div class="row">
    <div class="col-sm-12">
        <div class="content-header"> @lang('class.label.client_classe') </div>
                ...
                <div class="card-header">
                    ...
                    <div class="col-3">
                        <div class="actions pull-left">
                                ...
                                <a href="{{ url('/admin/client_classes/create') }}" class="btn btn-success btn-sm"
                                   title="Add New User">
...
<script>
    ...
    var url = "{{url('admin/client_classes')}}";
    ...
    datatable = $('.datatable').dataTable({
        ...
        ajax: {
            url: "{{ url('admin/client_classes/datatable') }}", // json datasource
