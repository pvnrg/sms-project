...
@section('title',trans('class.label.transaction'))

@section('content')

<div class="row">
    <div class="col-sm-12">
        <div class="content-header"> @lang('class.label.transaction') </div>
                ...
                <div class="card-header">
                    ...
                    <div class="col-3">
                        <div class="actions pull-left">                            
                            <a href="{{ url('/admin/transactions/create') }}" class="btn btn-success btn-sm"
                               title="Add New User">
                        ...
                        <div class="table-responsive">
                           <table class="table table-bordered table-striped datatable responsive">
                            ...
                            <tr>
                                ...
                                <th>@lang('class.label.client_id')</th>
                                <th>@lang('class.label.trade_date')</th>
...
<script>
    ...
    datatable = $('.datatable').dataTable({
        ...
        columns: [
            ...
            { "data": "client_id","name":"client_id","searchable": false,"width":"18%"},
            { "data": "trade_date","name":"trade_date","searchable": false,"width":"18%"},
        ...
        ajax: {
            url: "{{ url('admin/transactions/datatable') }}", // json datasource
