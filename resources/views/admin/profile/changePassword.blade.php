	            ...
	            <div class="card-header">
                        <a href="{{ route('profile.index') }}" title="@lang('common.label._back')">
                            <button class="btn-link-back"><i class="fa fa-arrow-left"
                                                                      aria-hidden="true"></i> @lang('common.label._back') </button>
                        </a>
	            ...
	            <div class="card-body">
	                <div class="px-3">
							...
							<div class="form-group row {{ $errors->has('password') ? ' has-error' : ''}}">
								{!! Form::label('password', trans('common.label.password'), ['class' => 'col-md-4 label-control']) !!}
								<div class="col-md-6">
							...
							<div class="form-group row">
								...
								<div class="col-md-offset-4 col-md-4">
									...
									{{ Form::reset(trans('common.label.clear_form'), ['class' => 'btn btn-primary']) }}
								</div>
							</div>
