    ...
    <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
            <label for="title" class="">
                ...
                {!! Form::text('name', isset($sec_ids->name) ? $sec_ids->name : '', ['class' => 'form-control']) !!}
        ...
        <div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
            <label for="description" class="">
                ...
                {!! Form::textarea('description', isset($sec_ids->description) ? $sec_ids->description : '', ['class' => 'form-control']) !!}
