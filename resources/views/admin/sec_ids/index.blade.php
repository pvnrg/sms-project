...
@section('title',trans('class.label.sec_ids'))

@section('content')

<div class="row">
    <div class="col-sm-12">
        <div class="content-header"> @lang('class.label.sec_ids') </div>
                ...
                <div class="card-header">
                    ...
                    <div class="col-3">
                        <div class="actions pull-left">
                                ...
                                <a href="{{ url('/admin/sec_ids/create') }}" class="btn btn-success btn-sm"
                                   title="Add New User">
...
<script>
    ...
    datatable = $('.datatable').dataTable({
        ...
        ajax: {
            url: "{{ url('admin/sec_ids/datatable') }}", // json datasource
